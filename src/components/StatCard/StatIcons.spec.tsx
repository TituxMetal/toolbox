...
describe('StatIcons', () => {
  ...
  describe('Component Export', () => {
    it('exports StatIcons as object', () => {
      expect(typeof StatIcons).toBe('object')
      expect(StatIcons).toBeTruthy()
    })
  })

  describe('Basic Rendering', () => {
    it('renders element with children', () => {
      const element = createElement(StatIcons, { children: 'Test content' })
      expect(element.type).toBe(StatIcons)
      expect(element.props.children).toBe('Test content')
    })

    it('renders with default props', () => {
      const element = createElement(StatIcons, { children: 'Default' })
  ...
  describe('Props Handling', () => {
    it('accepts className prop', () => {
      const element = createElement(StatIcons, {
  ...
  describe('Edge Cases', () => {
    it('handles empty children', () => {
      const element = createElement(StatIcons, { children: '' })
      expect(element.props.children).toBe('')
    })

    it('handles null children', () => {
      const element = createElement(StatIcons, { children: null })
      expect(element.props.children).toBe(null)
    })

    it('handles number children', () => {
      const element = createElement(StatIcons, { children: 42 })
      expect(element.props.children).toBe(42)
    })

    it('handles React element children', () => {
      const child = createElement('span', { children: 'Nested' })
      const element = createElement(StatIcons, { children: child })
